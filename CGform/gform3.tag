...
if subject contains 'english' or subject contains 'literature'
    ...
    category = "Sciences"
    click //div[@id='i15']
else if subject contains 'econ' or subject contains 'geo' or subject contains 'his' or subject contains 'art'
    category = "Humanities"
    click //div[@id='i18']
else if subject contains 'chi' or subject contains 'mal' or subject contains 'tam' or subject contains 'mother'
...
js subject = subject.split(",")
echo subject after split by comma to catch the first subject only is `subject`
click //div[@role='listbox']
//subject = "BASIC BAHASA MELAYU"
js arr = subject[0].split(" ")

echo arr subject is after splitting by space to catch only first word in the subject is `arr`
word = ""
js begin
