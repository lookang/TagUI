...
https://vle.learning.moe.edu.sg/admin/community-gallery?keyword=&location=COMMUNITY_GALLERY&resource=LESSON&status=PENDING_APPROVAL
wait 5
...
for i from 1 to (total-tableCnt*20)
	...
	if (exist('//*[@id="main-content"]/div/div/section/div/div[2]/div[2]/div/div[1]/table/tbody/tr[`rowCnt`]/td[1]/div/div/span/span'))
		...
		read //tbody/tr[1]/td[3]/div[1]/span[1] to subject 
	...
	echo `pending`
	js rowCnt++;
	js multipleof20 = total%20
	echo multipleof20 = `multipleof20`
	// goal is to skip this rowCnt == 21 if total is 20,40,60 etc
	if ((rowCnt == 21) and (multipleof20 != 0))
		{
		click //button[@aria-label="Next page"]
...
load 2024 CG Admin Subjects and Emails - CG Admin emails.csv to admin_table
