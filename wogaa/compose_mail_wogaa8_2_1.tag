...
filename = "singapore_student_learning_space_(sls)-daily-24_07_2022_1_filtered"
...
for i from start to filelength-1
	...
	// Subject
	type //input[@name="subjectbox"] as Forwarded WOGAA widget email `i` with rating greater than 5
