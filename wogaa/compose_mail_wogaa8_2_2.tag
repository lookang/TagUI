...
filename = "singapore_student_learning_space_(sls)-daily-24_07_2022_2_filtered"
...
// if start = 24, the email row is 25
start = 1
for i from start to filelength-1
	...
	//live
	type //input[@role='combobox'] as slscgbot@gmail.com
	...
	// Subject
	type //input[@name="subjectbox"] as Forwarded WOGAA widget email `i` with rating lesser than 4
	...
	dom document.querySelector('div[aria-label="Message Body"]').innerHTML = "Dear SLS Helpdesk, <br> This is an email sent automatically at "+ dom_json[0] + " from WOGAA Sentiment Response Daily File. <br>-------------------------------------------------------------------------- <br>Date/Time: "+dom_json[1]+" <br>Service Name: 	"+dom_json[2]+"<br>TXN ID: "+dom_json[3]+" <br>Page URL: "+dom_json[4]+" <br>Browser Version: "+dom_json[5]+" <br>OS/Device: "+dom_json[6]+" <br>Geographic: "+dom_json[7]+" <br>Rating: "+dom_json[8]+" <br>Email Address: "+dom_json[12]+" <br>Name: "+dom_json[11]+" <br>Message Title:	"+dom_json[10]+" <br>Message Body: "+dom_json[09]+" <br>-------------------------------------------------------------------------- <br><br> Regards, <br>SLS MOE Team"
